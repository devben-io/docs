...
<html lang="" >
    <head>
        ...
        <title>优化开发 · test search plus plugin</title>
    ...
    <link rel="next" href="Hot-loading-components.html" />
    
    
    <link rel="prev" href="Wing-It-Like-a-Pro.html" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.6.1" data-path="Optimizing-development.html">
...
<div class="search-plus" id="book-search-results">
    <div class="search-noresults">
                                ...
                                <p>We talked about how you could use the minified versions of your dependencies in development to make the rebundling go as fast as possible. Let us look at a small helper you can implement to make this a bit easier to handle.</p>
<p>&#x4E4B;&#x524D;&#x4ECB;&#x7ECD;&#x4E86;&#x5982;&#x4F55;&#x5728;&#x5F00;&#x53D1;&#x4E2D;&#x4F7F;&#x7528;&#x4F9D;&#x8D56;&#x7684;&#x538B;&#x7F29;&#x7248;&#x672C;&#x6765;&#x8BA9;&#x5408;&#x5E76;&#x5C3D;&#x53EF;&#x80FD;&#x52A0;&#x901F;&#xFF0C;&#x8BA9;&#x6211;&#x4EEC;&#x770B;&#x4E00;&#x4E0B;&#x8FD9;&#x4E2A;&#x5C0F;&#x7684;&#x4F8B;&#x5B50;&#x6765;&#x8BA9;&#x4F60;&#x66F4;&#x52A0;&#x8F7B;&#x677E;&#x53BB;&#x5904;&#x7406;&#xFF1A;</p>
...
<span class="hljs-keyword">var</span> node_modules_dir = path.join(__dirname, <span class="hljs-string">&apos;node_modules&apos;</span>);

<span class="hljs-keyword">var</span> deps = [
  <span class="hljs-string">&apos;react/dist/react.min.js&apos;</span>,
  <span class="hljs-string">&apos;react-router/dist/react-router.min.js&apos;</span>,
  <span class="hljs-string">&apos;moment/min/moment.min.js&apos;</span>,
...
<span class="hljs-comment">// Run through deps and extract the first part of the path, </span>
<span class="hljs-comment">// as that is what you use to require the actual node modules </span>
<span class="hljs-comment">// in your code. Then use the complete path to point to the correct</span>
<span class="hljs-comment">// file and make sure webpack does not try to parse it</span>
<span class="hljs-comment">// &#x901A;&#x8FC7;&#x5728;&#x7B2C;&#x4E00;&#x90E8;&#x5206;&#x8DEF;&#x5F84;&#x7684;&#x4F9D;&#x8D56;&#x548C;&#x89E3;&#x538B;</span>
<span class="hljs-comment">// &#x5C31;&#x662F;&#x4F60;&#x50CF;&#x5F15;&#x7528; node &#x6A21;&#x5757;&#x4E00;&#x6837;&#x5F15;&#x5165;&#x5230;&#x4F60;&#x7684;&#x4EE3;&#x7801;&#x4E2D;</span>
<span class="hljs-comment">// &#x7136;&#x540E;&#x4F7F;&#x7528;&#x5B8C;&#x6574;&#x8DEF;&#x5F84;&#x6307;&#x5411;&#x5F53;&#x524D;&#x6587;&#x4EF6;&#xFF0C;&#x7136;&#x540E;&#x786E;&#x8BA4; Webpack &#x4E0D;&#x4F1A;&#x5C1D;&#x8BD5;&#x53BB;&#x89E3;&#x6790;&#x5B83;</span>

deps.forEach(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">dep</span>) </span>{
  <span class="hljs-keyword">var</span> depPath = path.resolve(node_modules_dir, dep);
  config.resolve.alias[dep.split(path.sep)[<span class="hljs-number">0</span>]] = depPath;
  config.module.noParse.push(depPath);
});

<span class="hljs-built_in">module</span>.exports = config;
</code></pre>
<p>Not all modules include a minified distributed version of the lib, but most do. Especially with large libraries like React JS you will get a significant improvement.</p>
<p>&#x4E0D;&#x662F;&#x6240;&#x6709;&#x7684;&#x6A21;&#x5757;&#x9700;&#x8981;&#x4E00;&#x4E2A;&#x538B;&#x7F29;&#x7684;&#x7248;&#x672C;&#xFF0C;&#x4E0D;&#x8FC7;&#x5927;&#x591A;&#x6570;&#x9700;&#x8981;&#xFF0C;&#x5C24;&#x5176;&#x662F;&#x50CF; React JS &#x8FD9;&#x79CD;&#x5927;&#x578B;&#x5E93;&#xFF0C;&#x4E4B;&#x540E;&#x4F60;&#x4F1A;&#x6709;&#x660E;&#x663E;&#x7684;&#x63D0;&#x5347;&#x3002;</p>
<h2 id="&#x628A;-react-&#x66B4;&#x9732;&#x5230;&#x5168;&#x5C40;&#x4E2D;">&#x628A; React &#x66B4;&#x9732;&#x5230;&#x5168;&#x5C40;&#x4E2D;</h2>
<p>You might be using distributed versions that requires React JS on the global scope. To fix that you can install the expose-loader by <code>npm install expose-loader --save-dev</code> and set up the following config, focusing on the <em>module</em> property:</p>
<p>&#x4F60;&#x53EF;&#x80FD;&#x5728;&#x5168;&#x5C40;&#x4E2D;&#x4F7F;&#x7528;&#x4E86;&#x4E00;&#x4E2A;&#x538B;&#x7F29;&#x7248;&#x672C;&#x7684; React&#xFF0C;&#x4E3A;&#x4E86;&#x4FEE;&#x590D;&#x4F60;&#x53EF;&#x4EE5;&#x5B89;&#x88C5;&#x8FD9;&#x4E2A;&#x66B4;&#x9732;&#x5168;&#x5C40;&#x52A0;&#x8F7D;&#x5668; <code>npm install expose-loader --save-dev</code>&#xFF0C;&#x7136;&#x540E;&#x50CF;&#x4E0B;&#x9762;&#x8FD9;&#x6837;&#x914D;&#x7F6E;&#xFF0C;&#x6CE8;&#x610F; <em>module</em> &#x5C5E;&#x6027;&#xFF1A;</p>
<pre><code class="lang-javascript"><span class="hljs-keyword">var</span> webpack = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;webpack&apos;</span>);
<span class="hljs-keyword">var</span> path = <span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;path&apos;</span>);
<span class="hljs-keyword">var</span> node_modules_dir = path.join(__dirname, <span class="hljs-string">&apos;node_modules&apos;</span>);
...
<span class="hljs-keyword">var</span> config = {
  ...
  <span class="hljs-built_in">module</span>: {
    ...
    <span class="hljs-comment">// Use the expose loader to expose the minified React JS</span>
    <span class="hljs-comment">// distribution. For example react-router requires this</span>
    <span class="hljs-comment">// &#x4F7F;&#x7528;&#x66B4;&#x9732;&#x5168;&#x5C40;&#x52A0;&#x8F7D;&#x5668;&#x6765;&#x66B4;&#x9732;&#x538B;&#x7F29;&#x7248;&#x7684; React JS&#xFF0C;&#x6BD4;&#x5982; react-router &#x9700;&#x8981;&#x8FD9;&#x4E2A;&#x3002;</span>
    loaders: [{
      test: path.resolve(node_modules_dir, deps[<span class="hljs-number">0</span>]),
...
<span class="hljs-built_in">module</span>.exports = config;
    ...
    <div class="search-results">
        ...
        <div class="no-results">
            ...
            <h1 class="search-results-title">No results matching "<span class='search-query'></span>"</h1>
                ...
                <a href="Wing-It-Like-a-Pro.html" class="navigation navigation-prev " aria-label="Previous page: 进阶">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="Hot-loading-components.html" class="navigation navigation-next " aria-label="Next page: 热加载组件">
    ...
    <script>
        ...
        gitbook.push(function() {
            gitbook.page.hasChanged({"page":{"title":"优化开发","level":"1.6.1","depth":2,"next":{"title":"热加载组件","level":"1.6.2","depth":2,"path":"Hot-loading-components.md","ref":"Hot-loading-components.md","articles":[]},"previous":{"title":"进阶","level":"1.6","depth":1,"path":"Wing-It-Like-a-Pro.md","ref":"Wing-It-Like-a-Pro.md","articles":[{"title":"优化开发","level":"1.6.1","depth":2,"path":"Optimizing-development.md","ref":"Optimizing-development.md","articles":[]},{"title":"热加载组件","level":"1.6.2","depth":2,"path":"Hot-loading-components.md","ref":"Hot-loading-components.md","articles":[]},{"title":"使用下一代 JavaScript","level":"1.6.3","depth":2,"path":"JavaScript-next.md","ref":"JavaScript-next.md","articles":[]},{"title":"优化缓存","level":"1.6.4","depth":2,"path":"Optimizing-caching.md","ref":"Optimizing-caching.md","articles":[]},{"title":"匹配器","level":"1.6.5","depth":2,"path":"Matchers.md","ref":"Matchers.md","articles":[]},{"title":"懒加载入口","level":"1.6.6","depth":2,"path":"Lazy-loading-entry-points.md","ref":"Lazy-loading-entry-points.md","articles":[]},{"title":"创建一个复用代码","level":"1.6.7","depth":2,"path":"Creating-a-common-bundle.md","ref":"Creating-a-common-bundle.md","articles":[]},{"title":"理解 Chunks","level":"1.6.8","depth":2,"path":"Understanding-chunks.md","ref":"Understanding-chunks.md","articles":[]},{"title":"创建库","level":"1.6.9","depth":2,"path":"Authoring-libraries.md","ref":"Authoring-libraries.md","articles":[]}]},"dir":"ltr"},"config":{"plugins":["-lunr","-search","search-plus","fontsettings"],"root":"./content","styles":{"website":"styles/website.css","pdf":"styles/pdf.css","epub":"styles/epub.css","mobi":"styles/mobi.css","ebook":"styles/ebook.css","print":"styles/print.css"},"pluginsConfig":{"search-plus":{},"fontsettings":{"theme":"white","family":"sans","size":2},"highlight":{},"sharing":{"facebook":true,"twitter":true,"google":false,"weibo":false,"instapaper":false,"vk":false,"all":["facebook","google","twitter","weibo","instapaper"]},"theme-default":{"styles":{"website":"styles/website.css","pdf":"styles/pdf.css","epub":"styles/epub.css","mobi":"styles/mobi.css","ebook":"styles/ebook.css","print":"styles/print.css"},"showLevel":false}},"theme":"default","pdf":{"pageNumbers":true,"fontSize":12,"fontFamily":"Arial","paperSize":"a4","chapterMark":"pagebreak","pageBreaksBefore":"/","margin":{"right":62,"left":62,"top":56,"bottom":56}},"structure":{"langs":"LANGS.md","readme":"README.md","glossary":"GLOSSARY.md","summary":"SUMMARY.md"},"variables":{"version":"0.0.0"},"title":"test search plus plugin","gitbook":"*"},"file":{"path":"Optimizing-development.md","mtime":"2017-01-14T08:27:39.000Z","type":"markdown"},"gitbook":{"version":"3.2.2","time":"2017-04-25T12:02:48.767Z"},"basePath":".","book":{"language":""}});
        });
    </script>
</div>
