...
<html lang="" >
    <head>
        ...
        <title>使用下一代 JavaScript · test search plus plugin</title>
    ...
    <link rel="next" href="Optimizing-caching.html" />
    
    
    <link rel="prev" href="Hot-loading-components.html" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.6.3" data-path="JavaScript-next.html">
...
<div class="search-plus" id="book-search-results">
    <div class="search-noresults">
                                ...
                                <h2 id="&#x7C7B;">&#x7C7B;</h2>
<p>As of React JS 0.13 you will be able to define components as classes.</p>
<p>&#x5728; React JS 0.13 &#x4E2D;&#xFF0C;&#x4F60;&#x53EF;&#x4EE5;&#x628A;&#x7EC4;&#x4EF6;&#x5B9A;&#x4E49;&#x4E3A;&#x7C7B;&#x3002;</p>
<pre><code class="lang-javascript"><span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">MyComponent</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">React</span>.<span class="hljs-title">Component</span> </span>{
  <span class="hljs-keyword">constructor</span>() {
    <span class="hljs-keyword">this</span>.state = {message: <span class="hljs-string">&apos;Hello world&apos;</span>};
  }
  render() {
    <span class="hljs-keyword">return</span> (
      <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">h1</span>&gt;</span>{this.state.message}<span class="hljs-tag">&lt;/<span class="hljs-name">h1</span>&gt;</span></span>
    );
  }
}
</code></pre>
<p>This gives you a very short and nice syntax for defining components. A drawback with using classes though is the lack of mixins. That said, you are not totally lost. Lets us see how we could still use the important <strong>PureRenderMixin</strong>.</p>
<p>&#x8FD9;&#x6837;&#x80FD;&#x591F;&#x5199;&#x51FA;&#x975E;&#x5E38;&#x77ED;&#x4E14;&#x4F18;&#x96C5;&#x7684;&#x8BED;&#x6CD5;&#x6765;&#x5B9A;&#x4E49;&#x7EC4;&#x4EF6;&#x3002;&#x4F7F;&#x7528;&#x7C7B;&#x7684;&#x7F3A;&#x70B9;&#x662F;&#x7F3A;&#x4E4F;&#x4E86;&#x5F88;&#x591A; mixin&#xFF0C;&#x4E0D;&#x8FC7;&#xFF0C;&#x4E0D;&#x662F;&#x6240;&#x6709;&#x7684;&#x4E0D;&#x80FD;&#x7528;&#xFF0C;&#x8BA9;&#x6211;&#x4EEC;&#x6765;&#x770B;&#x770B;&#x4F7F;&#x7528;&#x91CD;&#x8981;&#x7684; <strong>PureRenderMixin</strong>&#xFF1A;</p>
<pre><code class="lang-javascript"><span class="hljs-keyword">import</span> React <span class="hljs-keyword">from</span> <span class="hljs-string">&apos;react/addons&apos;</span>;
...
<span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">Component</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">React</span>.<span class="hljs-title">Component</span> </span>{
  shouldComponentUpdate() {
    <span class="hljs-keyword">return</span> React.addons.PureRenderMixin.shouldComponentUpdate.apply(<span class="hljs-keyword">this</span>, <span class="hljs-built_in">arguments</span>);
  }
}
    ...
    <div class="search-results">
        ...
        <div class="no-results">
            ...
            <h1 class="search-results-title">No results matching "<span class='search-query'></span>"</h1>
                ...
                <a href="Hot-loading-components.html" class="navigation navigation-prev " aria-label="Previous page: 热加载组件">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="Optimizing-caching.html" class="navigation navigation-next " aria-label="Next page: 优化缓存">
