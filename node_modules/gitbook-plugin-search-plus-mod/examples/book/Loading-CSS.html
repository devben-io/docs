...
<html lang="" >
    <head>
        ...
        <title>加载 CSS · test search plus plugin</title>
    ...
    <link rel="next" href="Automatic-CSS-refresh.html" />
    
    
    <link rel="prev" href="CSS-Fonts-Images.md" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.4.1" data-path="Loading-CSS.html">
...
<div class="search-plus" id="book-search-results">
    <div class="search-noresults">
                                ...
                                <p>Webpack allows you to load CSS like you load any other code. What strategy you choose is up to you, but you can do everything from loading all your css in the main entry point file to one css file for each component.</p>
<p>Webpack&#x5141;&#x8BB8;&#x50CF;&#x52A0;&#x8F7D;&#x4EFB;&#x4F55;&#x4EE3;&#x7801;&#x4E00;&#x6837;&#x52A0;&#x8F7D; CSS&#x3002;&#x4F60;&#x53EF;&#x4EE5;&#x9009;&#x62E9;&#x4F60;&#x6240;&#x9700;&#x8981;&#x7684;&#x65B9;&#x5F0F;&#xFF0C;&#x4F46;&#x662F;&#x4F60;&#x53EF;&#x4EE5;&#x4E3A;&#x6BCF;&#x4E2A;&#x7EC4;&#x4EF6;&#x628A;&#x6240;&#x6709;&#x4F60;&#x7684; CSS &#x52A0;&#x8F7D;&#x5230;&#x5165;&#x53E3;&#x4E3B;&#x6587;&#x4EF6;&#x4E2D;&#x6765;&#x505A;&#x4EFB;&#x4F55;&#x4E8B;&#x60C5;&#x3002;</p>
<p>Loading CSS requires the <strong>css-loader</strong> and the <strong>style-loader</strong>. They have two different jobs. The <strong>css-loader</strong> will go through the CSS file and find <code>url()</code> expressions and resolve them. The <strong>style-loader</strong> will insert the raw css into a style tag on your page.</p>
<p>&#x52A0;&#x8F7D; CSS &#x9700;&#x8981; <strong>css-loader</strong> &#x548C; <strong>style-loader</strong>&#xFF0C;&#x4ED6;&#x4EEC;&#x505A;&#x4E24;&#x4EF6;&#x4E0D;&#x540C;&#x7684;&#x4E8B;&#x60C5;&#xFF0C;<strong>css-loader</strong>&#x4F1A;&#x904D;&#x5386; CSS &#x6587;&#x4EF6;&#xFF0C;&#x7136;&#x540E;&#x627E;&#x5230; <code>url()</code> &#x8868;&#x8FBE;&#x5F0F;&#x7136;&#x540E;&#x5904;&#x7406;&#x4ED6;&#x4EEC;&#xFF0C;<strong>style-loader</strong> &#x4F1A;&#x628A;&#x539F;&#x6765;&#x7684; CSS &#x4EE3;&#x7801;&#x63D2;&#x5165;&#x9875;&#x9762;&#x4E2D;&#x7684;&#x4E00;&#x4E2A; style &#x6807;&#x7B7E;&#x4E2D;&#x3002;</p>
<h2 id="&#x51C6;&#x5907;&#x52A0;&#x8F7D;-css">&#x51C6;&#x5907;&#x52A0;&#x8F7D; CSS</h2>
<p>Install the two loaders: <code>npm install css-loader style-loader --save-dev</code>.</p>
<p>&#x5B89;&#x88C5;&#x8FD9;&#x4E24;&#x4E2A;&#x52A0;&#x8F7D;&#x5668;&#xFF1A;<code>npm install css-loader style-loader --save-dev</code></p>
<p>In the <em>webpack.config.js</em> file you can add the following loader configuration:</p>
<p>&#x4F60;&#x53EF;&#x4EE5;&#x628A;&#x4E0B;&#x9762;&#x7684;&#x52A0;&#x8F7D;&#x5668;&#x914D;&#x7F6E;&#x52A0;&#x5230; <em>Webpack.config.js</em> &#x6587;&#x4EF6;&#x4E2D;&#x3002;</p>
...
<span class="hljs-keyword">var</span> config = {
  ...
  <span class="hljs-built_in">module</span>: {
    loaders: [{
      ...
      test: <span class="hljs-regexp">/\.css$/</span>, <span class="hljs-comment">// Only .css files</span>
      loader: <span class="hljs-string">&apos;style!css&apos;</span> <span class="hljs-comment">// Run both loaders</span>
    }]
  }
};
...
<p>Loading a CSS file is a simple as loading any file:</p>
<p>&#x52A0;&#x8F7D;&#x4E00;&#x4E2A; CSS &#x6587;&#x4EF6;&#x5C31;&#x548C;&#x52A0;&#x8F7D;&#x5176;&#x4ED6;&#x6587;&#x4EF6;&#x4E00;&#x6837;&#x7B80;&#x5355;&#xFF1A;</p>
<p><strong>main.js</strong></p>
<pre><code class="lang-javascript"><span class="hljs-keyword">import</span> <span class="hljs-string">&apos;./main.css&apos;</span>;
<span class="hljs-comment">// Other code</span>
</code></pre>
<p><strong>Component.jsx</strong></p>
<pre><code class="lang-javascript"><span class="hljs-keyword">import</span> <span class="hljs-string">&apos;./Component.css&apos;</span>;
...
<p><strong>Note!</strong> You can of course do this with both CommonJS and AMD.</p>
<p><strong>&#x6CE8;&#x610F;&#xFF01;</strong> &#x4F60;&#x4E5F;&#x53EF;&#x4EE5;&#x5728; CommonJS &#x548C; AMD &#x4E2D;&#x505A;&#x540C;&#x6837;&#x7684;&#x4E8B;&#x60C5;&#x3002;</p>
<h2 id="css-&#x52A0;&#x8F7D;&#x7B56;&#x7565;">CSS &#x52A0;&#x8F7D;&#x7B56;&#x7565;</h2>
...
<p>&#x6839;&#x636E;&#x4F60;&#x7684;&#x5E94;&#x7528;&#xFF0C;&#x4F60;&#x53EF;&#x80FD;&#x4F1A;&#x8003;&#x7565;&#x4E09;&#x79CD;&#x7B56;&#x7565;&#x3002;&#x53E6;&#x5916;&#xFF0C;&#x4F60;&#x9700;&#x8981;&#x8003;&#x8651;&#x628A;&#x4E00;&#x4E9B;&#x57FA;&#x7840;&#x7684; CSS &#x5185;&#x8054;&#x5230;&#x521D;&#x59CB;&#x5BB9;&#x5668;&#x4E2D;&#xFF08;index.html&#xFF09;&#xFF0C;&#x8FD9;&#x6837;&#x8BBE;&#x7F6E;&#x7684;&#x7ED3;&#x6784;&#x80FD;&#x591F;&#x5728;&#x5E94;&#x7528;&#x4E0B;&#x8F7D;&#x548C;&#x6267;&#x884C;&#x7684;&#x65F6;&#x5019;&#x52A0;&#x8F7D;&#x5269;&#x4E0B;&#x7684;&#x5E94;&#x7528;&#x3002;</p>
<h3 id="&#x6240;&#x6709;&#x5408;&#x5E76;&#x6210;&#x4E00;&#x4E2A;">&#x6240;&#x6709;&#x5408;&#x5E76;&#x6210;&#x4E00;&#x4E2A;</h3>
<p>In your main entry point, e.g. <code>app/main.js</code> you can load up your entire CSS for the whole project:</p>
<p>&#x5728;&#x4F60;&#x7684;&#x4E3B;&#x5165;&#x53E3;&#x6587;&#x4EF6;&#x4E2D;&#x4E2A;&#xFF0C;&#x6BD4;&#x5982; <code>app/main.js</code> &#x4F60;&#x53EF;&#x4EE5;&#x4E3A;&#x6574;&#x4E2A;&#x9879;&#x76EE;&#x52A0;&#x8F7D;&#x6240;&#x6709;&#x7684; CSS&#xFF1A;</p>
<p><strong>app/main.js</strong></p>
<pre><code class="lang-javascript"><span class="hljs-keyword">import</span> <span class="hljs-string">&apos;./project-styles.css&apos;</span>;
<span class="hljs-comment">// &#x5176;&#x4ED6; JS &#x4EE3;&#x7801;</span>
</code></pre>
...
<p>&#x5982;&#x679C;&#x4F60;&#x60F3;&#x53D1;&#x6325;&#x5E94;&#x7528;&#x4E2D;&#x591A;&#x91CD;&#x5165;&#x53E3;&#x6587;&#x4EF6;&#x7684;&#x4F18;&#x52BF;&#xFF0C;&#x4F60;&#x53EF;&#x4EE5;&#x5728;&#x6BCF;&#x4E2A;&#x5165;&#x53E3;&#x70B9;&#x5305;&#x542B;&#x5404;&#x81EA;&#x7684; CSS&#xFF1A;</p>
<p><strong>app/main.js</strong></p>
<pre><code class="lang-javascript"><span class="hljs-keyword">import</span> <span class="hljs-string">&apos;./style.css&apos;</span>;
<span class="hljs-comment">// &#x5176;&#x4ED6; JS &#x4EE3;&#x7801;</span>
</code></pre>
<p><strong>app/entryA/main.js</strong></p>
<pre><code class="lang-javascript"><span class="hljs-keyword">import</span> <span class="hljs-string">&apos;./style.css&apos;</span>;
<span class="hljs-comment">// &#x5176;&#x4ED6; JS &#x4EE3;&#x7801;</span>
</code></pre>
<p><strong>app/entryB/main.js</strong></p>
<pre><code class="lang-javascript"><span class="hljs-keyword">import</span> <span class="hljs-string">&apos;./style.css&apos;</span>;
<span class="hljs-comment">// &#x5176;&#x4ED6; JS &#x4EE3;&#x7801;</span>
</code></pre>
...
<p>&#x4F60;&#x628A;&#x4F60;&#x7684;&#x6A21;&#x5757;&#x7528;&#x6587;&#x4EF6;&#x5939;&#x5206;&#x79BB;&#xFF0C;&#x6BCF;&#x4E2A;&#x6587;&#x4EF6;&#x5939;&#x6709;&#x5404;&#x81EA;&#x7684; CSS &#x548C; JavaScript &#x6587;&#x4EF6;&#x3002;&#x518D;&#x6B21;&#xFF0C;&#x5F53;&#x5E94;&#x7528;&#x53D1;&#x5E03;&#x7684;&#x65F6;&#x5019;&#xFF0C;&#x5BFC;&#x5165;&#x7684; CSS &#x5DF2;&#x7ECF;&#x52A0;&#x8F7D;&#x5230;&#x6BCF;&#x4E2A;&#x5165;&#x53E3;&#x6587;&#x4EF6;&#x4E2D;&#x3002;</p>
<h3 id="&#x5236;&#x5B9A;&#x7684;&#x7EC4;&#x4EF6;">&#x5236;&#x5B9A;&#x7684;&#x7EC4;&#x4EF6;</h3>
...
<p><strong>app/components/MyComponent.css</strong></p>
<pre><code class="lang-css"><span class="hljs-selector-class">.MyComponent-wrapper</span> {
  <span class="hljs-attribute">background-color</span>: <span class="hljs-number">#EEE</span>;
}
</code></pre>
<p><strong>app/components/MyComponent.jsx</strong></p>
...
</code></pre><h2 id="&#x4F7F;&#x7528;&#x5185;&#x8054;&#x6837;&#x5F0F;&#x53D6;&#x4EE3;-css-&#x6587;&#x4EF6;">&#x4F7F;&#x7528;&#x5185;&#x8054;&#x6837;&#x5F0F;&#x53D6;&#x4EE3; CSS &#x6587;&#x4EF6;</h2>
<p>With &quot;React Native&quot; you do not use stylesheets at all, you only use the <em>style-attribute</em>. By defining your CSS as objects. Depending on your project, you might consider this as your CSS strategy.</p>
<p>&#x5728; &#x201C;React Native&#x201D; &#x4E2D;&#x4F60;&#x4E0D;&#x518D;&#x9700;&#x8981;&#x4F7F;&#x7528;&#x4EFB;&#x4F55; CSS &#x6587;&#x4EF6;&#xFF0C;&#x4F60;&#x53EA;&#x9700;&#x8981;&#x4F7F;&#x7528; <em>style &#x5C5E;&#x6027;</em>&#xFF0C;&#x53EF;&#x4EE5;&#x628A;&#x4F60;&#x7684; CSS &#x5B9A;&#x4E49;&#x6210;&#x4E00;&#x4E2A;&#x5BF9;&#x8C61;&#xFF0C;&#x90A3;&#x6837;&#x5C31;&#x53EF;&#x4EE5;&#x6839;&#x636E;&#x4F60;&#x7684;&#x9879;&#x76EE;&#x91CD;&#x65B0;&#x6765;&#x8003;&#x7565;&#x4F60;&#x7684; CSS &#x7B56;&#x7565;&#x3002;</p>
<p><strong>app/components/MyComponent.jsx</strong></p>
  ...
  render: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    ...
    <div class="search-results">
        ...
        <div class="no-results">
            ...
            <h1 class="search-results-title">No results matching "<span class='search-query'></span>"</h1>
                ...
                <a href="CSS-Fonts-Images.md" class="navigation navigation-prev " aria-label="Previous page: CSS, Fonts and Images">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="Automatic-CSS-refresh.html" class="navigation navigation-next " aria-label="Next page: 自动刷新 CSS">
    ...
    <script>
        ...
        gitbook.push(function() {
            gitbook.page.hasChanged({"page":{"title":"加载 CSS","level":"1.4.1","depth":2,"next":{"title":"自动刷新 CSS","level":"1.4.2","depth":2,"path":"Automatic-CSS-refresh.md","ref":"Automatic-CSS-refresh.md","articles":[]},"previous":{"title":"CSS, Fonts and Images","level":"1.4","depth":1,"path":"CSS-Fonts-Images.md","ref":"CSS-Fonts-Images.md","articles":[{"title":"加载 CSS","level":"1.4.1","depth":2,"path":"Loading-CSS.md","ref":"Loading-CSS.md","articles":[]},{"title":"自动刷新 CSS","level":"1.4.2","depth":2,"path":"Automatic-CSS-refresh.md","ref":"Automatic-CSS-refresh.md","articles":[]},{"title":"加载 LESS 和 SASS","level":"1.4.3","depth":2,"path":"Loading-LESS-or-SASS.md","ref":"Loading-LESS-or-SASS.md","articles":[]},{"title":"内联 images","level":"1.4.4","depth":2,"path":"Inlining-images.md","ref":"Inlining-images.md","articles":[]},{"title":"内联 fonts","level":"1.4.5","depth":2,"path":"Inlining-fonts.md","ref":"Inlining-fonts.md","articles":[]}]},"dir":"ltr"},"config":{"plugins":["-lunr","-search","search-plus","fontsettings"],"root":"./content","styles":{"website":"styles/website.css","pdf":"styles/pdf.css","epub":"styles/epub.css","mobi":"styles/mobi.css","ebook":"styles/ebook.css","print":"styles/print.css"},"pluginsConfig":{"search-plus":{},"fontsettings":{"theme":"white","family":"sans","size":2},"highlight":{},"sharing":{"facebook":true,"twitter":true,"google":false,"weibo":false,"instapaper":false,"vk":false,"all":["facebook","google","twitter","weibo","instapaper"]},"theme-default":{"styles":{"website":"styles/website.css","pdf":"styles/pdf.css","epub":"styles/epub.css","mobi":"styles/mobi.css","ebook":"styles/ebook.css","print":"styles/print.css"},"showLevel":false}},"theme":"default","pdf":{"pageNumbers":true,"fontSize":12,"fontFamily":"Arial","paperSize":"a4","chapterMark":"pagebreak","pageBreaksBefore":"/","margin":{"right":62,"left":62,"top":56,"bottom":56}},"structure":{"langs":"LANGS.md","readme":"README.md","glossary":"GLOSSARY.md","summary":"SUMMARY.md"},"variables":{"version":"0.0.0"},"title":"test search plus plugin","gitbook":"*"},"file":{"path":"Loading-CSS.md","mtime":"2017-01-14T08:27:39.000Z","type":"markdown"},"gitbook":{"version":"3.2.2","time":"2017-04-25T12:02:48.767Z"},"basePath":".","book":{"language":""}});
        });
    </script>
</div>
