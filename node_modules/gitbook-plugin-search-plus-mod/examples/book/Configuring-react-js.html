...
<html lang="" >
    <head>
        ...
        <title>配置 React JS · test search plus plugin</title>
    ...
    <link rel="next" href="Optimizing-rebundling.html" />
    
    
    <link rel="prev" href="Introduction-to-React-JS.html" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.3.1" data-path="Configuring-react-js.html">
...
<div class="search-plus" id="book-search-results">
    <div class="search-noresults">
                                ...
                                <h2 id="&#x5B89;&#x88C5;-react-js">&#x5B89;&#x88C5; React JS</h2>
<p><code>npm install react --save</code></p>
<p>There is really nothing more to it. You can now start using React JS in your code.</p>
<p>&#x6CA1;&#x4EC0;&#x4E48;&#x597D;&#x8BB2;&#x7684;&#xFF0C;&#x63A5;&#x4E0B;&#x6765;&#x5C31;&#x53EF;&#x4EE5;&#x5728;&#x4F60;&#x7684;&#x4EE3;&#x7801;&#x4E2D;&#x4F7F;&#x7528; React JS &#x4E86;&#x3002;</p>
<h2 id="&#x5728;&#x4EE3;&#x7801;&#x4E2D;&#x4F7F;&#x7528;-reactjs">&#x5728;&#x4EE3;&#x7801;&#x4E2D;&#x4F7F;&#x7528; ReactJS</h2>
<p><strong>component.jsx</strong></p>
<pre><code class="lang-javascript"><span class="hljs-keyword">import</span> React <span class="hljs-keyword">from</span> <span class="hljs-string">&apos;react&apos;</span>;

<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">Hello</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">React</span>.<span class="hljs-title">Component</span> </span>{
  render() {
...
<pre><code class="lang-javascript"><span class="hljs-keyword">import</span> React <span class="hljs-keyword">from</span> <span class="hljs-string">&apos;react&apos;</span>;
<span class="hljs-keyword">import</span> Hello <span class="hljs-keyword">from</span> <span class="hljs-string">&apos;./component.jsx&apos;</span>;

main();

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">main</span>(<span class="hljs-params"></span>) </span>{
    React.render(<span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">Hello</span> /&gt;</span>, document.getElementById(&apos;app&apos;));
}
</span></code></pre>
...
<p>To use the JSX syntax you will need webpack to transform your JavaScript. This is the job of a loader. We&apos;ll use <a href="https://babeljs.io/" target="_blank">Babel</a> as it&apos;s nice and has plenty of features.</p>
<p>&#x4E3A;&#x4E86;&#x80FD;&#x591F;&#x4F7F;&#x7528; JSX &#x8BED;&#x6CD5;&#xFF0C;&#x4F60;&#x9700;&#x8981;&#x7528; Webpack &#x6765;&#x8F6C;&#x7801;&#x4F60;&#x7684; JavaScript&#xFF0C;&#x8FD9;&#x662F;&#x52A0;&#x8F7D;&#x5668;&#x7684;&#x5DE5;&#x4F5C;&#xFF0C;&#x6211;&#x4EEC;&#x53EF;&#x4EE5;&#x4F7F;&#x7528;&#x4E00;&#x4E2A;&#x5F88;&#x597D;&#x7528;&#x4E5F;&#x6709;&#x5F88;&#x591A;&#x529F;&#x80FD;&#x7684; <a href="https://babeljs.io/" target="_blank">Babel</a>&#x3002;</p>
<p><code>npm install babel-loader babel-core --save-dev</code></p>
<p>Now we have to configure webpack to use this loader.</p>
<p>&#x73B0;&#x5728;&#x6211;&#x4EEC;&#x9700;&#x8981;&#x53BB;&#x914D;&#x7F6E; Webpack &#x6765;&#x4F7F;&#x7528;&#x52A0;&#x8F7D;&#x5668;&#x3002;</p>
...
<span class="hljs-keyword">var</span> config = {
  ...
  <span class="hljs-built_in">module</span>: {
    loaders: [{
      test: <span class="hljs-regexp">/\.jsx?$/</span>, <span class="hljs-comment">// &#x7528;&#x6B63;&#x5219;&#x6765;&#x5339;&#x914D;&#x6587;&#x4EF6;&#x8DEF;&#x5F84;&#xFF0C;&#x8FD9;&#x6BB5;&#x610F;&#x601D;&#x662F;&#x5339;&#x914D; js &#x6216;&#x8005; jsx</span>
      loader: <span class="hljs-string">&apos;babel&apos;</span> <span class="hljs-comment">// &#x52A0;&#x8F7D;&#x6A21;&#x5757; &quot;babel&quot; &#x662F; &quot;babel-loader&quot; &#x7684;&#x7F29;&#x5199;</span>
    }]
  }
};
...
<p>Webpack will test each path required in your code. In this project we are using ES6 module loader syntax, which means that the require path of <code>import MyComponent from &apos;./Component.jsx&apos;;</code> is <code>&apos;./Component.jsx&apos;</code>.</p>
<p>Webpack &#x4F1A;&#x5728;&#x4F60;&#x7684;&#x9879;&#x76EE;&#x4E2D;&#x6D4B;&#x8BD5;&#x6240;&#x6709;&#x8DEF;&#x5F84;&#xFF0C;&#x5982;&#x679C;&#x6211;&#x4EEC;&#x9879;&#x76EE;&#x4E2D;&#x4F7F;&#x7528; ES6 &#x6A21;&#x5757;&#x52A0;&#x8F7D;&#x5668;&#x8BED;&#x6CD5;&#xFF0C;&#x6BD4;&#x5982; <code>import MyComponent from &apos;./Component.jsx&apos;;</code> &#x662F;&#x4F1A;&#x53BB;&#x5339;&#x914D; <code>&apos;./Component.jsx&apos;</code>&#x3002;</p>
<p>Run <code>npm run dev</code> in the console and refresh the page to see something.</p>
<p>&#x5728;&#x547D;&#x4EE4;&#x884C;&#x4E2D;&#x8FD0;&#x884C; <code>npm run dev</code>&#xFF0C;&#x7136;&#x540E;&#x5237;&#x65B0;&#x9875;&#x9762;&#x5C31;&#x53EF;&#x4EE5;&#x770B;&#x5230;&#x4FEE;&#x6539;&#x3002;</p>
    ...
    <div class="search-results">
        ...
        <div class="no-results">
            ...
            <h1 class="search-results-title">No results matching "<span class='search-query'></span>"</h1>
                ...
                <a href="Introduction-to-React-JS.html" class="navigation navigation-prev " aria-label="Previous page: React JS">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="Optimizing-rebundling.html" class="navigation navigation-next " aria-label="Next page: 优化重合并">
