...
<html lang="" >
    <head>
        ...
        <title>优化重合并 · test search plus plugin</title>
    ...
    <link rel="next" href="Type-checking-with-flow.html" />
    
    
    <link rel="prev" href="Configuring-react-js.html" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.3.2" data-path="Optimizing-rebundling.html">
...
<div class="search-plus" id="book-search-results">
    <div class="search-noresults">
                                ...
                                <p>You might notice after requiring React JS into your project that the time it takes from a save to a finished rebundle of your application takes more time. In development you ideally want from 200-800 ms rebundle speed, depending on what part of the application you are working on.</p>
<p>&#x4F60;&#x53EF;&#x80FD;&#x6CE8;&#x610F;&#x5230;&#x5728;&#x5F15;&#x5165; React JS &#x5230;&#x4F60;&#x7684;&#x9879;&#x76EE;&#x4E4B;&#x540E;&#xFF0C;&#x7ED9;&#x4F60;&#x7684;&#x5E94;&#x7528;&#x91CD;&#x65B0;&#x5408;&#x5E76;&#x4F1A;&#x82B1;&#x8D39;&#x592A;&#x591A;&#x7684;&#x65F6;&#x95F4;&#x3002;&#x5728;&#x5F00;&#x53D1;&#x73AF;&#x5883;&#x4E2D;&#xFF0C;&#x6700;&#x7406;&#x60F3;&#x7684;&#x662F;&#x7F16;&#x8BD1;&#x6700;&#x591A; 200 &#x5230; 800 &#x6BEB;&#x79D2;&#x7684;&#x901F;&#x5EA6;&#xFF0C;&#x53D6;&#x51B3;&#x4E8E;&#x4F60;&#x5728;&#x5F00;&#x53D1;&#x7684;&#x5E94;&#x7528;&#x3002;</p>
<blockquote>
<p>IMPORTANT! This setup a minified, production version of React. As a result you will lose <code>propTypes</code> based type validation!</p>
<p>&#x6CE8;&#x610F;&#xFF01;&#x8FD9;&#x4E2A;&#x662F;&#x8BBE;&#x7F6E;&#x4E00;&#x4E2A;&#x538B;&#x7F29;&#x548C;&#x53D1;&#x5E03;&#x7684; React &#x7248;&#x672C;&#xFF0C;&#x7ED3;&#x679C;&#x4F60;&#x53EF;&#x80FD;&#x4F1A;&#x5931;&#x53BB; <code>propTypes</code> &#x57FA;&#x7840;&#x7C7B;&#x578B;&#x68C0;&#x67E5;&#xFF01;</p>
</blockquote>
<h2 id="&#x5728;&#x5F00;&#x53D1;&#x73AF;&#x5883;&#x4E2D;&#x4F7F;&#x7528;&#x538B;&#x7F29;&#x6587;&#x4EF6;">&#x5728;&#x5F00;&#x53D1;&#x73AF;&#x5883;&#x4E2D;&#x4F7F;&#x7528;&#x538B;&#x7F29;&#x6587;&#x4EF6;</h2>
<p>Instead of making Webpack go through React JS and all its dependencies, you can override the behavior in development.</p>
<p>&#x4E3A;&#x4E86;&#x4E0D;&#x8BA9; Webpack &#x53BB;&#x904D;&#x5386; React JS &#x53CA;&#x5176;&#x6240;&#x6709;&#x4F9D;&#x8D56;&#xFF0C;&#x4F60;&#x53EF;&#x4EE5;&#x5728;&#x5F00;&#x53D1;&#x4E2D;&#x91CD;&#x5199;&#x5B83;&#x7684;&#x884C;&#x4E3A;&#x3002;</p>
...
config = {
    entry: [<span class="hljs-string">&apos;webpack/hot/dev-server&apos;</span>, path.resolve(__dirname, <span class="hljs-string">&apos;app/main.js&apos;</span>)],
    resolve: {
        alias: {
...
<p>We do two things in this configuration:</p>
<p>&#x6211;&#x4EEC;&#x5728;&#x914D;&#x7F6E;&#x4E2D;&#x505A;&#x4E86;&#x4E24;&#x4EF6;&#x4E8B;&#xFF1A;</p>
<ol>
<li><p>Whenever &quot;react&quot; is required in the code it will fetch the minified React JS file instead of going to <em>node_modules</em></p>
</li>
<li><p>Whenever Webpack tries to parse the minified file, we stop it, as it is not necessary</p>
</li>
</ol>
<ol>
<li>&#x6BCF;&#x5F53; &quot;react&quot; &#x5728;&#x4EE3;&#x7801;&#x4E2D;&#x88AB;&#x5F15;&#x5165;&#xFF0C;&#x5B83;&#x4F1A;&#x4F7F;&#x7528;&#x538B;&#x7F29;&#x540E;&#x7684; React JS &#x6587;&#x4EF6;&#xFF0C;&#x800C;&#x4E0D;&#x662F;&#x5230; <em>node_modules</em> &#x4E2D;&#x627E;&#x3002;</li>
<li>&#x6BCF;&#x5F53; Webpack &#x5C1D;&#x8BD5;&#x53BB;&#x89E3;&#x6790;&#x90A3;&#x4E2A;&#x538B;&#x7F29;&#x540E;&#x7684;&#x6587;&#x4EF6;&#xFF0C;&#x6211;&#x4EEC;&#x963B;&#x6B62;&#x5B83;&#xFF0C;&#x56E0;&#x4E3A;&#x8FD9;&#x4E0D;&#x5FC5;&#x8981;&#x3002;</li>
</ol>
<p>Take a look at <a href="Optimizing-development">Optimizing development</a> for more information on this.</p>
<p>&#x53EF;&#x4EE5;&#x5230; <a href="Optimizing-development">&#x4F18;&#x5316;&#x5F00;&#x53D1;</a> &#x770B;&#x5230;&#x66F4;&#x591A;&#x8FD9;&#x65B9;&#x9762;&#x7684;&#x4FE1;&#x606F;&#x3002;</p>
    ...
    <div class="search-results">
        ...
        <div class="no-results">
            ...
            <h1 class="search-results-title">No results matching "<span class='search-query'></span>"</h1>
                ...
                <a href="Configuring-react-js.html" class="navigation navigation-prev " aria-label="Previous page: 配置 React JS">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="Type-checking-with-flow.html" class="navigation navigation-next " aria-label="Next page: Flow">
